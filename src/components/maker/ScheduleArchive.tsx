          ...
          <div className="flex items-start justify-between gap-2 mb-2">
              ...
              {isEditing ? (
                ...
                <div className="flex items-center gap-1.5 group/title">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-5 w-5 opacity-0 group-hover/title:opacity-100 text-slate-400 hover:text-blue-500 transition-all"
            ...
            {!isEditing && (
              <Button
                variant="ghost"
                size="icon"
                className="h-6 w-6 text-slate-300 hover:text-red-500 hover:bg-red-50 -mt-1 -mr-1 shrink-0"
